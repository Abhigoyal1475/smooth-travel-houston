...
import { Bus, Car, Plane, Compass, MapPin, University, Phone, CreditCard } from 'lucide-react';
import { TransportDetails } from '@/components/TransportDetailsDialog';

export const transportOptionsData: TransportDetails[] = [
  {
    id: 0,
    title: "COAST Card (UH Students)",
    icon: <CreditCard />,
    howToUse: [
      "Check eligibility: Available to students who live off-campus and outside the COAST boundaries",
      "Apply through AccessUH under the COAST tab",
      "Receive your COAST Q Card at the beginning of the semester",
      "Use your card for unlimited rides on all METRO services"
    ],
    costs: [
      "Free for eligible UH students",
      "$27 monthly subsidy loaded onto your COAST Card",
      "Valid on all METRO services including bus, rail, and Park & Ride"
    ],
    discounts: "The COAST (Cougar Optional Alternative Semester Transportation) program provides eligible UH students with a subsidized METRO Q Card. Students receive $27 per month in transit funds, which covers most commuting needs for the semester.",
    tips: "The COAST boundaries are defined as: North of I-610, East of Hardy Toll Road, South of Brays Bayou, and West of I-45. Students living outside these boundaries are eligible for the program.",
    referralLink: "https://www.uh.edu/parking/transportation-options/coast/",
    routes: [
      { name: "Program Eligibility", duration: "Off-campus students outside boundaries", cost: "FREE" },
      { name: "How to Apply", duration: "AccessUH → COAST application", cost: "FREE" },
      { name: "Monthly Subsidy", duration: "$27/month on METRO Q Card", cost: "FREE" }
    ],
    shortDescription: "COAST (Cougar Optional Alternative Semester Transportation) provides eligible UH students with a subsidized METRO Q Card, offering $27 monthly for public transit. This program is specifically designed for students living off-campus and outside the COAST boundaries."
  },
  {
    id: 1,
